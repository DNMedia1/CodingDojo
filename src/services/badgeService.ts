...
const badgeRules: BadgeRule[] = [
  { id: 'first-lesson', title: 'Erste Schritte', description: 'Schliesse deine erste Lektion ab.', icon: '🌱', isEarned: (p) => countCompletedLessons(p) >= 1 },
  { id: 'lessons-10', title: 'Dranbleiber', description: 'Schliesse 10 Lektionen ab.', icon: '📚', isEarned: (p) => countCompletedLessons(p) >= 10 },
  { id: 'lessons-25', title: 'Lernmaschine', description: 'Schliesse 25 Lektionen ab.', icon: '🚀', isEarned: (p) => countCompletedLessons(p) >= 25 },
  { id: 'lessons-50', title: 'Marathon', description: 'Schliesse 50 Lektionen ab.', icon: '🏗️', isEarned: (p) => countCompletedLessons(p) >= 50 },
  ...
  { id: 'course-complete', title: 'Kurs gemeistert', description: 'Schliesse einen kompletten Kurs ab.', icon: '🎓', isEarned: hasCompletedAnyCourse },
  { id: 'explorer', title: 'Sprachen-Scout', description: 'Schliesse Lektionen in 4 verschiedenen Kursen ab.', icon: '🧭', isEarned: (p) => countTouchedCourses(p) >= 4 }
];
